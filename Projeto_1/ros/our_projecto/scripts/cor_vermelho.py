...
def indentifica_cor1(frame):
	...
	if not maior_contorno is None :
	    ...
	    mediaR = maior_contorno.mean(axis=0)
	    mediaR = mediaR.astype(np.int32)
	    cv2.circle(frame, tuple(mediaR), 5, [0, 255, 0])
	else:
	    mediaR = (0, 0)
	...
	centroR = (frame.shape[0]//2, frame.shape[1]//2)

	return mediaR, centroR
